# Quality Review Summary - Round 14

**Profile:** agentic-release-gate
**Generated:** 2026-07-08T09:02:48.054Z
**Git:** "" @ ""
...
**To continue:**
```bash
node skills/release-quality-review/scripts/review-runner.mjs --profile agentic-release-gate --round 15
```
