...
## 评审维度
请读取完整定义: H:\02-areas\cli-bridge\skills\release-quality-review/reviewers/architecture-maintainer.md
...
## 输出要求
在 H:\02-areas\cli-bridge\quality-reports/round-{N}/architecture-maintainer/ 目录下创建:
- result.yaml - 机器可读结果
- score.md - 评分详情
