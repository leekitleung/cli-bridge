...
请执行 product-flow 的评审。

## 评审维度
请读取完整定义: H:\02-Areas\cli-bridge\skills\release-quality-review/reviewers/product-flow.md
...
## 输出要求
在 H:\02-Areas\cli-bridge\quality-reports/round-{N}/product-flow/ 目录下创建:
- result.yaml - 机器可读结果
- score.md - 评分详情
